...
**/
class Xcck_AdminRenderSystem extends Legacy_AdminRenderSystem
{
    /**
     * prepare
     * 
    ...
    **/
    public function renderTheme(/*** XCube_RenderTarget ***/ &$target)
    {
        ...
        $info = Xcck_AdminRenderSystem::getOverrideFileInfo('admin_theme.html');
        $this->mSmarty->template_dir = ($info['file'] != null) ?
            substr($file['path'],0,-15) :
            XCCK_ADMIN_RENDER_FALLBACK_PATH;
    ...
    **/
    ...
    {
        $info = Xcck_AdminRenderSystem::getOverrideFileInfo($str);
        if($info['url'] != null)
        {
            return $info['url'];
        }
        return XCCK_ADMIN_RENDER_FALLBACK_URL . '/' . $str;
    }
    ...
    **/
    public static function functionStylesheet(/*** {string 'file',string 'media'} ***/ $param,/*** Smarty ***/ &$smarty)
    {
        ...
        $info = Xcck_AdminRenderSystem::getOverrideFileInfo($params['file'],'stylesheets/');
        if($info['file'] == null)
        {
            return;
        }
