...
define('_MD_XCCK_ERROR_PAGE_TREE_INFINITE_LOOP', 'Invalid parent page id. Don\'t assign descendant page id as parent id.');
...
define('_MD_XCCK_DESC_FIELD_ENUM', 'Set ENUM Class name.');
