...
define('_MD_XCCK_LANG_ADD_A_NEW_COMPONENT', "データの追加");
define('_MD_XCCK_LANG_COMPONENT_ID', "データ番号");
...
define('_MD_XCCK_LANG_COMPONENT_EDIT', "データの編集");
define('_MD_XCCK_LANG_COMPONENT_DELETE', "データの削除");
...
define('_MD_XCCK_TIPS_OPTIONS', '<p>「タイプ」が……</p><ul><li>Selectbox または Checkbox の場合：選択肢を改行で区切って入力してください</li><li>String, Int の場合：初期値を入れてください。</li><li>Text の場合："html" と入れると、Wysiwygエディタになります（初期値はBBコードエディタ）</li><li>Categoryの場合：カテゴリモジュールのディレクトリ名を入れてください。</li></ul>');
...
define('_MD_XCCK_LANG_COMPONENT_TREE', 'ページツリー');
...
define('_MD_XCCK_LANG_COMPONENT_TREE_DELETE', 'このページの子ページも同時に削除されます。');
?>
