...
class Xcck_CatCategoryManager extends Xcck_AbstractCategoryManager
{
    ...
    **/
    ...
    {
        $tree = null;
        XCube_DelegateUtils::call('Legacy_Category.'.$this->_mCategoryDir.'.GetTree', new XCube_Ref($tree), $this->_mCategoryDir, $this->_getAuthType($action), $categoryId, null, true);
        return $tree;
    }
